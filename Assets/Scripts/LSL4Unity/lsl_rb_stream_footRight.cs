...
public class lsl_rb_stream_footRight : MonoBehaviour {
	...
	// set LSL parameters
	public const string StreamName = "Rigid_footR";
	...
	void Start () 
	{
        ...
        footR = GameObject.Find("RightFoot");
	...
	private void pushSample()
	{
		...
		else
		{
			...
			currentSample[0] = footR.transform.position.x;
			currentSample[1] = footR.transform.position.y;
			currentSample[2] = footR.transform.position.z;
			currentSample[3] = footR.transform.rotation.x;
			currentSample[4] = footR.transform.rotation.y;
			currentSample[5] = footR.transform.rotation.z;
			currentSample[6] = footR.transform.rotation.w;
