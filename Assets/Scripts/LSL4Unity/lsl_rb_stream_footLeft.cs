...
public class lsl_rb_stream_footLeft : MonoBehaviour {
	...
	// set LSL parameters
	public const string StreamName = "Rigid_footL";
	...
	void Start () 
	{
        ...
        footL = GameObject.Find("LeftFoot");
	...
	private void pushSample()
	{
		...
		else
		{
			...
			currentSample[0] = footL.transform.position.x;
			currentSample[1] = footL.transform.position.y;
			currentSample[2] = footL.transform.position.z;
			currentSample[3] = footL.transform.rotation.x;
			currentSample[4] = footL.transform.rotation.y;
			currentSample[5] = footL.transform.rotation.z;
			currentSample[6] = footL.transform.rotation.w;
